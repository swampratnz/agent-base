...
- `src/agent/rateReservers.ts` — The two media-input reservation caps (per-sender daily image-input and hourly voice-transcription reservers) the platform adapters check before any media download.
